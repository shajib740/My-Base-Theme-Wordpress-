<?php
	...
	if ( ! class_exists( 'Pranon_Base_Walker' ) ):

		class Pranon_Base_Walker extends Walker_Nav_Menu {
			...
			public static function fallback( $args ) {
				if ( current_user_can( 'manage_options' ) ) {
					$fb_output = '<li class="menu-item"><a href="' . esc_url( home_url( '/' ) ) . '">' . esc_html__( 'Home', 'blogey' ) . '</a></li>';
					$fb_output .= '<li class="menu-item"><a target="_blank" href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '">' . esc_html__( 'Add Menu', 'blogey' ) . '</a></li>';
